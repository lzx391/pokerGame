...
|----------------------|--------|----------|
| `default` | 默认明亮 | 灰底、白面板，与早期对局页接近 |
| `scifi` | 科幻霓虹 | 深色底、青蓝霓虹描边与高对比强调色 |
| `gothic` | 暗黑哥特 | 暗褐紫底、衬线字体、金/酒红点缀 |
| `macau` | 澳门风云 | 赌桌墨绿台呢感、金边丝绒面板、筹码红与祖母绿点缀 |
| `midnight` | 午夜蓝调 | 深海蓝底、银蓝描边与冷灰字，夜场贵宾厅气质 |
| `forest` | 森荫秘境 | 苔绿深林、琥珀与嫩绿强调，户外木屋牌桌感 |
| `sunset` | 落日熔金 | 暮紫底、顶部霞光、暖橙与洋红底池对比 |
| `ink` | 水墨宣纸 | 浅宣纸底、墨灰字、朱砂红强调（唯一浅色预制主题） |
...
- **`dp-poker-cards.css` / `dp-game-community-cards.css`** 中扑克牌渐变与扫光未按主题分叉。
