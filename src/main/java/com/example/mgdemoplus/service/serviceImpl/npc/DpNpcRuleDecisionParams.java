...
import com.example.mgdemoplus.service.serviceImpl.DpNpcEngine.TablePosition;
import com.example.mgdemoplus.utils.DpUtilHandEvaluator.SimpleStrength;

import java.util.Random;

/**
 * {@link com.example.mgdemoplus.service.serviceImpl.DpNpcEngine#decideBotAction} 在分发到各规则 NPC 策略类时的入参快照。
 */
