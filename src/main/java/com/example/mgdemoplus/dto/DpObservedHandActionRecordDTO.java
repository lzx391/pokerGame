 ...
 */
public final class DpObservedHandActionRecordDTO {
    ...
    public DpObservedHandActionRecordDTO(long tsMs, String stage, String actorNickname, DpObservedHandActionType type,
