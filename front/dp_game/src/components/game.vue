<template>
  ...
  >
    ...
    <game-top-bar
        ...
        @update:game-ui-theme="$store.commit('dpGame/SET_GAME_UI_THEME', $event)"
        :eco-mode="ecoMode"
        @update:eco-mode="$store.commit('dpGame/SET_ECO_MODE', $event)"
