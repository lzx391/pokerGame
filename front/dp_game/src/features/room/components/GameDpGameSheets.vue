  ...
  <div>
    ...
    >
      ...
      <game-owner-tool-modal
          ...
          :can-manage-experimental-deck-preset="vm.canManageExperimentalDeckPreset"
          :can-npc-decision-trace="vm.canNpcDecisionTrace"
          :owner-reveal-all="vm.ownerRevealAll"
    ...
    <game-npc-decision-trace-dock
        v-if="vm.canNpcDecisionTrace && !vm.useDecisionTraceDockWide"
        layout-mode="sheet"
        ...
        :on-auth-failure="(body) => vm.handleNpcDecisionTraceAuthFailure(body)"
...
import GameNpcMoodSheet from '@features/npc/components/GameNpcMoodSheet.vue'
import GameHandHistoryModal from './GameHandHistoryModal.vue'
import GameInviteFriendSheet from '@features/social/components/GameInviteFriendSheet.vue'
import GameInviteFriendPanel from '@features/social/components/GameInviteFriendPanel.vue'
import GameFriendChatSheet from '@features/social/components/GameFriendChatSheet.vue'
import GameFriendChatPanel from '@features/social/components/GameFriendChatPanel.vue'
...
import CustomNpcStyleDialog from '@features/npc/components/CustomNpcStyleDialog.vue'
