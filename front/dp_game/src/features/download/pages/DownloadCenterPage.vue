...
import { dpAxiosErrorMessage, dpResultMessage, dpResultSuccess } from '@shared/utils/dpApiResult'
import DownloadAdminPasswordGate from '../components/DownloadAdminPasswordGate.vue'
import DpRetroConfirmDialog from '@shared/components/DpRetroConfirmDialog.vue'

export default {
  name: 'DownloadCenterPage',
